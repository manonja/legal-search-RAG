...
echo -e "${GREEN}Test RAG search:${NC} curl -X POST '${API_URL}/query/rag' -H '${AUTH_HEADER}' -H 'Content-Type: application/json' -d '{\"query\": \"${TEST_QUERY}\", \"max_results\": 5, \"temperature\": 0.7, \"max_tokens\": 1000}' | jq"
